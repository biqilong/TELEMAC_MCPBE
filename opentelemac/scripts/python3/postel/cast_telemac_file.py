...
from data_manip.extraction.parser_selafin import subset_variables_slf, get_value_history,\
                                   get_value_polyline, get_value_polyplan
from pretel.meshes import xys_locate_mesh, slice_mesh
from postel.mycast import what_time_slf
import numpy as np

class CastTelemacFile(TelemacFile):
    """
    Caster over TelemacFile class
    """
    ...
    def cast_history_at_points(self, what_vars, what_time, what_points):
        ...
        itime = parse_array_frame(what_time, len(self.tags['times']))
        ...
        data = get_value_history(self, itime, support3d, vrs)
    ...
    def cast_profile_at_polyline(self, what_vars, what_time, what_points):
        ...
        data = get_value_polyline(self, itime, support3d, vrs)
        # Distance d-axis
        distot = 0.0
        dist = [distot]
    ...
    def cast_vmesh_at_polyline(self, what_time, what_points):
        ...
        itime = what_time_slf(what_time, self.tags['times'])
        meshz = np.ravel(get_value_polyline(\
                     self, itime, support3d,
                     varz)[0][0].T)
    ...
    def cast_hmesh_at_levels(self, what_points):
        ...
        return self.ikle2, self.meshx[:self.npoin2],\
               self.meshy[:self.npoin2], zpo
    ...
    def cast_vmesh_at_levels(self, what_time, what_points):
        ...
        return self.ikle3, self.meshx, self.meshy,\
                 get_value_polyplan(self, itime, zpo,
                                    vrs)[0][0]
    ...
    def cast_hvalue_at_levels(self, what_vars, what_time, what_points):
        ...
        data = get_value_polyplan(self, itime, zpo, vrs)
        varsors = []
    ...
    def cast_values(self, what_vars, what_time):
        ...
        times = what_time_slf(what_time, self.tags['times'])
        # what_vars: list of pairs variables:support2d delimited by ';'
