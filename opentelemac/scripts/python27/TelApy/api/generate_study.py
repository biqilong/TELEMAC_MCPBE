...
def generate_set(input_variable):
    ...
    if 'INDEX' in input_variable['VAR_INFO']['ZONE_DEF']:
        ...
        poly_file = input_variable['VAR_INFO']['ZONE_DEF']\
                                  ['POLYGON_FILE']['FILE_NAME']
        poly_sep = input_variable['VAR_INFO']['ZONE_DEF']\
                                 ['POLYGON_FILE']['SEPARATOR']
...
def get_result_keyword(module):
    ...
    if module == 'Telemac2d':
        ...
        raise Exception(["module "+module+" is not handled "\
...
def generate_study_yacs(jdc):
    ...
    try:
        ...
        raise Exception(["Missing Salome this function "\
