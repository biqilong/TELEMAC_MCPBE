...
class TelemacFile(object):
    ...
    def get_mesh_title(self):
        ...
        title, ierr = TelemacFile._hermes.get_mesh_title(self.fformat,
                                                         self.my_id)
        if ierr != 0:
    ...
    def get_mesh_date(self):
        ...
        ierr = TelemacFile._hermes.get_mesh_date(self.fformat,
                                                 self.my_id, date)
        if ierr != 0:
    ...
    def get_mesh_connectivity(self):
        ...
        ierr = TelemacFile._hermes.get_mesh_connectivity(\
    ...
    def get_mesh_npoin(self):
        ...
        npoin, ierr = TelemacFile._hermes.get_mesh_npoin(\
                           self.fformat, self.my_id, self.typ_elem)
        if ierr != 0:
    ...
    def get_bnd_value(self):
        ...
        ierr = TelemacFile._hermes.get_bnd_color(self.fformat, self.my_id,
                                                 self.typ_bnd_elem,
                                                 color)
        if ierr != 0:
            raise Exception("The function get_bnd_color crashed \
                             with the following error %d" % ierr)
