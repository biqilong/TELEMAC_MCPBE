...
void stdSerafinReader :: createIndex ()
{
	...
	// Taille du fichier - taille des métadonnées - IPOB0 - IKLE - table de X - table de Y
	...
	// Nombre de variables * nombre d'éléments si le fichier est en VolFin 
	...
	//[ci dessus] Si c'est en 3D, on zappe les valeurs de Z pour obetnir la taille d'un bloc de données de discrétisation
