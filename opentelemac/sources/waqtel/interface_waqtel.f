...
!
     ...
     &   ZPROP,T1,T21,T3,T4,T5,T6,T7,T8,T9,T10,T11,T12,DEBUG,UN,VN)
        USE BIEF_DEF
        IMPLICIT NONE
...
!
      INTERFACE
        SUBROUTINE CALCS3D_MICROPOL (NPOIN2,TN,TEXP,
     &    TIMP,ZPROP,CF,UN,VN,T2_1,T2_2,T2_3,T3_1,T3_2,DEBUG)
        USE BIEF_DEF
        IMPLICIT NONE
...
!
      INTERFACE
        SUBROUTINE CALCS3D_THERMICV(NPOIN2,NPOIN3,NPLAN,Z,TA,TEXP,
...
!
     ...
     &  (MESH,IELM1,VENT,WINDX,WINDY,ATMOS,PATMOS,MESH3D,IELM3)
        USE BIEF_DEF
        IMPLICIT NONE
!
