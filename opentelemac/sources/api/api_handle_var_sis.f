...
!
      MODULE API_HANDLE_VAR_SIS
        ...
        INTEGER, PARAMETER :: NB_VAR_SIS=38
...
!
        ...
        ELSE IF(TRIM(VARNAME).EQ.'MODEL.QBOR') THEN
          VALEUR(1:INST%QBOR%DIM1) = INST%QBOR%R(1:INST%QBOR%DIM1)
        ELSE IF(TRIM(VARNAME).EQ.'MODEL.EBOR') THEN
          VALEUR(1:INST%EBOR%DIM1) = INST%EBOR%R(1:INST%EBOR%DIM1)
...
!
        ...
        ELSE IF(TRIM(VARNAME).EQ.'MODEL.QBOR') THEN
          INST%QBOR%R(1:INST%QBOR%DIM1) = VALEUR(1:INST%QBOR%DIM1)
        ELSE IF(TRIM(VARNAME).EQ.'MODEL.EBOR') THEN
          INST%EBOR%R(1:INST%EBOR%DIM1) = VALEUR(1:INST%EBOR%DIM1)
        ELSE IF(TRIM(VARNAME).EQ.'MODEL.FLBOR') THEN
