...
!
!>    Concentration of sediment at time n per class
!
...
!>    Index in varsor for output variables
!
      INTEGER NVAR_RATIOS,NVAR_QSCL,NVAR_CS,NVAR_QS_C,NVAR_QSXC,
...
!
      DOUBLE PRECISION, ALLOCATABLE ::  CONC_MUD_ACTIV_LAYER(:)
!
!>    Mass of mud in active layer (array defined for temporary work in some subroutines)
!
      DOUBLE PRECISION, ALLOCATABLE ::  MASS_MUD_ACTIV_LAYER(:)
!
