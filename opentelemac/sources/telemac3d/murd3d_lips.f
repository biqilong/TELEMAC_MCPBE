...
!
     ...
     & KSCE,SOURCES,FSCE,RAIN,PLUIE,TRAIN,NPOIN2,MINFC,MAXFC,
...
!+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+
!
      INTEGER          :: I,ISEG,IPOIN,IPTFR3,IELEM
      INTEGER          :: IS,IIS,I1,I2,I3,I4,I5,I6,ICOR,N,IP,ITER
      DOUBLE PRECISION :: SECU2,C,LOCALMIN,LOCALMAX,COEF
...
!
        SECU2=0.9999999D0
        DO I=1,NPOIN3
          TETAF_VAR(I)=MAX(0.D0,1.D0-SECU2*TRA02(I)/DDT)
        ENDDO
!
!----------------------------------------------------------------------
!       PREDICTOR STEP
