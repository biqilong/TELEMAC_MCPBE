...
!
      INTERFACE
        SUBROUTINE COEFRO(CF,H,U,V,KARMAN,KFROT,CHESTR,GRAV,MESH,T1,LGI)
      USE BIEF_DEF
      IMPLICIT NONE
...
!
     ...
     &  BILMAS,FU,FV,YASMO,YACORIOL,CORIOLIS,SPHERIC,SINLAT,LEO,
     &  NREG,TNP,PT_IN_POLY)
!
      USE BIEF_DEF
      IMPLICIT NONE
      ...
      INTEGER, INTENT(IN)    :: NREG
      INTEGER, INTENT(IN)    :: TNP(NREG),PT_IN_POLY(MAXSCE,NPOIN)
