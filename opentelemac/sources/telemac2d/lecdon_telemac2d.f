...
!
      ...
      USE DROGUES, ONLY: NDRG_CLSS,DRG_DENSITY
...
!     &      DIMEN(2,78).GT.NALG_CLSS .OR.
!     &      DIMEN(2,79).GT.NALG_CLSS
!     &    ) THEN
...
!           MASS OF ALGAE PER UNIT AREA
            MALGAE(I) = MOTREA( ADRESS(2,79)+I-1 )
!           ALGAE RELEASE TYPE
