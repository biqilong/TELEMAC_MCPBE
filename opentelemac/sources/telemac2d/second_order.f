...
!
     ...
     & CORR_ZR,IVIS,AIRST,VNOIN,ELTSEG,IFABOR,NUBO,CMI,LIMPRO,HC)
!
!***********************************************************************
! TELEMAC2D
!***********************************************************************
...
!>@param  [in,out]  CE         FLUX INCREMENT AT INTERFACES
...
!
      IMPLICIT NONE
!
      INTEGER, INTENT(IN) :: IVIS,ELTSEG(NELEM,3),IFABOR(NELEM,3)
...
!
      ...
      DOUBLE PRECISION, INTENT(IN) :: CMI(2,NSEG)
...
!-----------------------------------------------------------------------
!
      CE(:,1)=(/(0.D0,IS=1,NPOIN)/)
      CE(:,2)=(/(0.D0,IS=1,NPOIN)/)
      CE(:,3)=(/(0.D0,IS=1,NPOIN)/)
!
      CALL GRADNOD(IKLE%I,UA,MESH%DPX%R,MESH%DPY%R,DJX,DJY,DX,DY,IVIS,
     &             CE)
!
!-----------------------------------------------------------------------
!
