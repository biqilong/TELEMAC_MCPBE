...
!
      INTERFACE
        SUBROUTINE CONWAC
     &( CX    , CY    , CT    , XK    , CG    , NPOIN2, NPLAN , JF    ,
     &  NF    )
      IMPLICIT NONE
      INTEGER, INTENT(IN)             :: NF,NPLAN,NPOIN2,JF
      DOUBLE PRECISION, INTENT(IN)    :: CG(NPOIN2,NF),XK(NPOIN2,NF)
...
!
      INTERFACE
        SUBROUTINE ECRSPE
     &( F     , NPLAN , NF    , NPOIN2, LT, AUXIL , NOLEO ,
...
!
      INTERFACE
        SUBROUTINE FPREAD( FREAD, F, NF, NPLAN, NPOIN2, EXPO )
      IMPLICIT NONE
...
!
      INTERFACE
        SUBROUTINE FREM01( FM01 , F, NF, NPLAN, NPOIN2)
      IMPLICIT NONE
      INTEGER,          INTENT(IN) ::  NF    , NPLAN , NPOIN2
      DOUBLE PRECISION, INTENT(IN) :: F(NPOIN2,NPLAN,NF)
...
!
      INTERFACE
        SUBROUTINE FREM02( FM02, F, NF, NPLAN, NPOIN2)
      IMPLICIT NONE
      INTEGER,          INTENT(IN) ::  NF    , NPLAN , NPOIN2
      DOUBLE PRECISION, INTENT(IN) :: F(NPOIN2,NPLAN,NF)
...
!
      INTERFACE
        SUBROUTINE FREMOY( FMOY, F, NF, NPLAN, NPOIN2)
      IMPLICIT NONE
      INTEGER,         INTENT(IN) ::  NF    , NPLAN , NPOIN2
      DOUBLE PRECISION,INTENT(IN) :: F(NPOIN2,NPLAN,NF)
...
!
      INTERFACE
        SUBROUTINE FREPIC( FPIC, F, NF, NPLAN, NPOIN2)
      IMPLICIT NONE
      INTEGER,INTENT(IN)             :: NF    , NPLAN , NPOIN2
      DOUBLE PRECISION,INTENT(IN)    :: F(NPOIN2,NPLAN,NF)
...
!
      INTERFACE
        SUBROUTINE LECSUI
     &(F,NPLAN,NF,NPOIN2,VENT,COURAN,NPRE,FMTPRE, MAREE,TRA01)
      IMPLICIT NONE
...
!V6P1 New subroutine
      INTERFACE
        SUBROUTINE QNLIN2
     &( TSTOT , TSDER , IANGNL,  COEFNL, NF    , NPLAN , NPOIN2, F     ,
...
!
      INTERFACE
        SUBROUTINE DIR_SPREAD( DIRSPR, F, NPLAN, NF, NPOIN2)
      IMPLICIT NONE
      INTEGER, INTENT(IN)    :: NF    , NPLAN , NPOIN2
      DOUBLE PRECISION, INTENT(IN)    :: F(NPOIN2,NPLAN,NF)
...
!
      INTERFACE
        SUBROUTINE TOTNRJ( VARIAN, F, NF, NPLAN, NPOIN2)
      IMPLICIT NONE
      INTEGER, INTENT(IN)    ::          NF    , NPLAN , NPOIN2
      DOUBLE PRECISION, INTENT(IN)    :: F(NPOIN2,NPLAN,NF)
...
!
      INTERFACE
        SUBROUTINE UVSTOKES
     &       (UST, VST, WST, FS, NPOIN2, XK1, ZFJ, NPLAN, ZTEL,NZ,NF)
      IMPLICIT NONE
...
!
      INTERFACE
        SUBROUTINE VITFON(VIFOND,F,XK,NF,NPOIN2,NPLAN)
      IMPLICIT NONE
      INTEGER, INTENT(IN)             :: NF,NPLAN,NPOIN2
      DOUBLE PRECISION, INTENT(IN)    :: F(NPOIN2,NPLAN,NF)
      DOUBLE PRECISION, INTENT(IN)    :: XK(NPOIN2,NF)
...
!
      INTERFACE
        SUBROUTINE WIPJ
     & (  WIP, FS, NPOIN2, XK, WIPDX, WIPDY,NPLAN,NF)
      INTEGER, INTENT(IN)    :: NPOIN2,NPLAN,NF
      DOUBLE PRECISION, INTENT(IN)    :: FS(NPOIN2,NPLAN,NF)
      DOUBLE PRECISION, INTENT(IN)    :: XK(NPOIN2,NF)
