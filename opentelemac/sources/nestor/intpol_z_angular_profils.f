...
!
      ...
      !
!
!      dbug WRITE(6,*)'?>-------  SR Intpol_Z_angular_Profils -----'
      SRname%s = "Intpol_Z_angular_Profils"                     ! subroutine name
!
...
!
        ...
        F%refZ(i) = z1  + intpolFaktAngle  * ( z2  - z1  )  ! circumferential z-interpolation between z1 and z2
!
!        ______________________________________________________________
        ! Interpolate measure of river length _________________________|
        F%km(i) = P1km + intpolFaktAngle*( P2km - P1km )
!
      ENDDO    !  i=1 , F%nNodes
!
!      dbug WRITE(6,*)'?>-------  SR Intpol_Z_angular_Profils END--'
      RETURN
!***                                              ********************************************
!***                                              ********************************************
#endif
