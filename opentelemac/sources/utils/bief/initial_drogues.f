...
!
!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
!| NP      |-->| NUMBER OF PARCELS TO BE CREATED
!| NP_MAX  |-->| MAXIMUM NUMBER OF PARCELS TO BE CREATED
!| NPOIN   |-->| NUMBER OF NODE IN THE MESH
...
!-----------------------------------------------------------------------
!
!     WEIGTHED SAMPLING BY POINTS (SUB-ELEMENT TRIANGLES)
!
      DO IP = 1,NPI
!       RANDOM SAMPLE
...
!-----------------------------------------------------------------------
!
!     SAMPLING AROUND WEIGTHED POINTS, ONE TRIANGLE AT A TIME
      IP = NP
      DO IEL = 1,NEL
!
        J = PELEM(1,IEL)
...
!
!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
!| XP,YP   |<--| COORDINATES OF THE NP NEW (RANDOMLY SAMPLED) PARCELS
!| NP      |-->| NUMBER OF PARCELS TO BE CREATED
!| ITAG    |-->| TAGGING RANGE FOR PARCELS PER PROCESSOR
!| XN,YN   |-->| WHERE N = 1,2,3, COORDINATES OF THE TRIANGLE WITHIN
!|         |---|   WHICH THE NEW NP PARCELS WILL BE RANDOMLY SELECTED
!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
!
!***********************************************************************
!
...
!|         |---|   WHICH THE NEW NP PARCELS WILL BE RANDOMLY SELECTED
!| NY      |-->| NUMBER OF PLOYGONS
!| IY      |-->| ARRAYS OF NUMBER OF POINT PER POLYGONS
!| VY      |-->| ARRYAS OF VALUES PER POLYGONS
!| NG      |-->| TOTAL NUMBER OF POINTS GROUPING ALL POLYGONS
!| XG      |-->| X-COORDINATE FOR ALL POINTS IN ALL POLYGONS
!| YG      |-->| Y-COORDINATE FOR ALL POINTS IN ALL POLYGONS
!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
!
!***********************************************************************
!
