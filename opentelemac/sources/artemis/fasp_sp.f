...
! ->QUADRANT 1 :
        IF( DIFX.LE.0.D0 .AND. DIFY.LE.0.D0) THEN
          IF(DIST.LE.DIST1)THEN
            IF(DEBUG.GT.0) X1=XRELV(N)
            IF(DEBUG.GT.0) Y1=YRELV(N)
            DIST1=DIST
            N1=N
            OK1 = .TRUE.
            INUM = INUM + 1
...
! ->QUADRANT 2 :
        ELSEIF( DIFX.GE.0.D0 .AND. DIFY.LE.0.D0) THEN
          IF(DIST.LE.DIST2)THEN
            IF(DEBUG.GT.0) X2=XRELV(N)
            IF(DEBUG.GT.0) Y2=YRELV(N)
            DIST2=DIST
            N2=N
            OK2 = .TRUE.
            INUM = INUM + 1
...
! ->QUADRANT 3 :
        ELSEIF( DIFX.GE.0.D0 .AND. DIFY.GE.0.D0) THEN
          IF(DIST.LE.DIST3)THEN
            IF(DEBUG.GT.0) X3=XRELV(N)
            IF(DEBUG.GT.0) Y3=YRELV(N)
            DIST3=DIST
            N3=N
            OK3 = .TRUE.
            INUM = INUM + 1
...
! ->QUADRANT 4 :
        ELSEIF( DIFX.LE.0.D0 .AND. DIFY.GE.0.D0) THEN
          IF(DIST.LE.DIST4)THEN
            IF(DEBUG.GT.0) X4=XRELV(N)
            IF(DEBUG.GT.0) Y4=YRELV(N)
            DIST4=DIST
            N4=N
            OK4 = .TRUE.
            INUM = INUM + 1
