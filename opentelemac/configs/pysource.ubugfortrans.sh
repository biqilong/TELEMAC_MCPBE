...
export HOMETEL=/mnt/c/Users/saaad264/Source/TELEMAC_MCPBE/opentelemac
# Adding python scripts to PATH
export PATH=$HOMETEL/scripts/python3:.:$PATH
# Configuration file
export SYSTELCFG=$HOMETEL/configs/systel.cis-win10-ubuntu.cfg
# Name of the configuration to use
export USETELCFG=ubugfortrans
# Path to this file
export SOURCEFILE=$HOMETEL/configs/pysource.ubugfortrans.sh
### Python
