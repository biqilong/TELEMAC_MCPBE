...
\begin{itemize}
\item  if using the JMJ database, the name of the database (typically bdd\_jmj) is given by the keyword \telkey{ASCII DATABASE FOR TIDE} et the corresponding mesh file is specified using the keyword \telkey{TIDAL MODEL FILE},
