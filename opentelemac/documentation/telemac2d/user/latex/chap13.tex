...
\label{sec:culverts}
 ...
 Information about culvert characteristics is stored in the \textit{CULVERTS DATA FILE}.
...
The culvert discharge is calculated based on the formulae given in the theory guide of TELEMAC-3D 
