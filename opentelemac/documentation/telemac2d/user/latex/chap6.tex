...
(default value is NO).
 ...
 $\rho_{air}$ is approximately 1.2 kg/m$^3$ and $\rho$ is 1,000 kg/m$^3$. Thus it is necessary to divide the value of a${}_{wind}$ by 1,000 to obtain the value of the \telemac{2D} keyword.
