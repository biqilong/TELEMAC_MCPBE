...
this option is not implemented while there are multiple choices of implementation.
...
if $5 < \| \overrightarrow{U}_{vent} \| < 19.22$ m/s &
 $a_{vent} = (- 0.12 + 0.137 \| \overrightarrow{U}_{vent} \| ) 10^{-3}$ \\
...
NO). The value of that pressure is set in the \telfile{METEO} subroutine
with the value of \telkey{VALUE OF ATMOSPHERIC PRESSURE}.
