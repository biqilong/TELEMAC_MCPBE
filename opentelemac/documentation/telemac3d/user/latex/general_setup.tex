...
\telfile{USER\_MESH\_TRANSF} subroutine to define the array \telfile{ZSTAR}
that describes
...
values as provided by the keyword \telkey{INITIAL ELEVATION}
...
can contain up to \telfile{MAXFRO} reals,
and therefore up to \telfile{MAXFRO} boundaries of that kind
...
\telfile{MAXFRO} reals, and therefore up \telfile{MAXFRO}
...
can contain up to \telfile{MAXFRO} reals,
and therefore up \telfile{MAXFRO} boundaries of that kind can
