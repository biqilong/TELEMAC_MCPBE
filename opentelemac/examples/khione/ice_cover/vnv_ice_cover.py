...
class VnvStudy(AbstractVnvStudy):
    ...
    def _pre(self):
        ...
        """
        # TODO: debug parallel cases
        # TODO: debug partially ice covered test cases
...
#        # cas 1 parallel
#        #cas.set('PARALLEL PROCESSORS', 4)
#        #self.add_study('vnv_2_par', 'telemac2d', 't2d_cover.cas', cas=cas)
#        del cas
...
#        # cas 1 parallel
#        #cas.set('PARALLEL PROCESSORS', 4)
#        #self.add_study('vnv_3_par', 'telemac2d', 't2d_cover.cas', cas=cas)
#        del cas
...
#        # cas 1 parallel
#        #cas.set('PARALLEL PROCESSORS', 4)
#        #self.add_study('vnv_4_par', 'telemac2d', 't2d_cover.cas', cas=cas)
#        del cas
...
#                            'f2d_hydro_v01.slf',
#                            eps=[1.E-3])
#        self.check_epsilons('vnv1_seq:ICERES',
#                            'fce_cover_v01.slf',
#                            eps=[1.E-3])
