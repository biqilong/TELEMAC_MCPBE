...
\begin{minipage}[t]{\textwidth}
 \centering
 \includegraphicsmaybe{[width=\textwidth]}{../img/U-2d_scalarmap_2h.png}
\end{minipage}
\begin{minipage}[t]{\textwidth}
 \centering
 \includegraphicsmaybe{[width=\textwidth]}{../img/T-2d_scalarmap_2h.png}
\end{minipage}
\begin{minipage}[t]{\textwidth}
 \centering
 \includegraphicsmaybe{[width=\textwidth]}{../img/Cf-2d_scalarmap_2h.png}
\end{minipage}
\begin{minipage}[t]{\textwidth}
 \centering
 \includegraphicsmaybe{[width=\textwidth]}{../img/Hg-2d_scalarmap_2h.png}
\end{minipage}
