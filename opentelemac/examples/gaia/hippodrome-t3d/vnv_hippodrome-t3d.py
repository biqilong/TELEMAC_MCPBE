...
class VnvStudy(AbstractVnvStudy):
    ...
    def _pre(self):
        ...
        self.add_study('vnv_9',
                       'telemac3d',
                       't3d_1NCObs_4CO_consolidation.cas')


        # hippodrome parallel mode T3D+GAI
        cas = TelemacCas('t3d_1NCObs_4CO_consolidation.cas', get_dico('telemac3d'))
        cas.set('PARALLEL PROCESSORS', 4)

        self.add_study('vnv_10',
                       'telemac3d',
                       't3d_1NCObs_4CO_consolidation_par.cas',
                       cas=cas)
    ...
    def _check_results(self):
        ...
        self.check_epsilons('vnv_3:GAIRES',
                            ...
                            eps=[1e-8, 1e-8, 1e-8, 1e-8, 1.e-8, 2.e-4,\
                                 1e-8, 1e-8, 1e-8, 1e-8, 1.e-7, 1.e-8,\
                                 1e-8, 1e-8, 1e-8, 1e-8, 1.e-8, 1.e-8,\
                                 1e-8, 1e-8, 1e-8, 1e-8, 1.e-8, 1.e-8,\
                                 1e-8, 1e-8, 1e-8, 1e-8, 1.e-8])
        ...
        self.check_epsilons('vnv_9:GAIRES',
                            'gai_ref_1NCObs_4CO_consolidation.slf',
                            eps=[])
