...
\begin{figure} [!h] %[!ht]
\centering
\includegraphicsmaybe{[width=\textwidth]}{../img/gai_bump2d-ini.png}
...
\begin{figure} [!ht]
\centering
%\includegraphics[scale=0.6, bb=0 0 30 30]{../img/gai_bump2d-t2d.png}
\includegraphicsmaybe{[scale=0.6]}{../img/gai_bump2d-t2d.png}
