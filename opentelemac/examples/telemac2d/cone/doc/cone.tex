...
LIPS and predictor-corrector (PC) schemes as well as NERD have steeper slope of convergence comprised
between one and two.
...
Convergence slopes in $L^2$ norm are compared on figure \ref{t2d:cone:error_timeintegrals}.
