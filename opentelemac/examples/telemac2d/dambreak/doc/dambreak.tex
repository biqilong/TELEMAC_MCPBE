...
\begin{minipage}[t]{0.5\textwidth}
 \centering
 \includegraphicsmaybe{[width=\textwidth]}{../img/t2d_ritter_hllc_depth_firstobs100.png}
\end{minipage}%
\begin{minipage}[t]{0.5\textwidth}
 \centering
 \includegraphicsmaybe{[width=\textwidth]}{../img/t2d_ritter_hllc_vel_firstobs100.png}
\end{minipage}
...
\begin{figure}[H]
 \centering
 \includegraphicsmaybe{[width=\textwidth]}{../img/t2d_ritter_hllc_depth2d_firstobs100.png}
...
\begin{figure}[H]
 \centering
 \includegraphicsmaybe{[width=\textwidth]}{../img/t2d_ritter_hllc_vel2d_firstobs100.png}
...
\begin{figure}[H]
\centering
\includegraphicsmaybe{[width=0.8\textwidth]}{../img/t2d_ritter_maxT.png}
...
\begin{minipage}[t]{0.5\textwidth}
 \centering
 \includegraphicsmaybe{[width=\textwidth]}{../img/t2d_stoker_hllc_depth_firstobs100.png}
\end{minipage}%
\begin{minipage}[t]{0.5\textwidth}
 \centering
 \includegraphicsmaybe{[width=\textwidth]}{../img/t2d_stoker_hllc_vel_firstobs100.png}
\end{minipage}
  \caption{Water depth and velocity with the HLLC scheme.}
...
%\begin{figure}[H]
% \centering
% \includegraphicsmaybe{[width=\textwidth]}{../img/t2d_stoker_hllc_depth2d_firstobs100.png}
%  \caption{Water depth in 2D with the HLLC scheme.}
%  \label{fig:stoker:Hfirstobs1d}
%\end{figure}
%
%\begin{figure}[H]
% \centering
% \includegraphicsmaybe{[width=\textwidth]}{../img/t2d_stoker_hllc_vel2d_firstobs100.png}
%  \caption{Velocity norm in 2D with the HLLC scheme.}
%  \label{fig:stoker:Ufirstobs1d}
%\end{figure}
...
\begin{figure}[H]
\centering
\includegraphicsmaybe{[width=0.8\textwidth]}{../img/t2d_stoker_maxT.png}
