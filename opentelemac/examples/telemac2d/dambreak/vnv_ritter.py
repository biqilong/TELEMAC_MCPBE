...
class VnvStudy(AbstractVnvStudy):
    ...
    def _check_results(self):
        ...
        self.check_epsilons('hllc_seq:T2DRES', 'f2d_ritter-hllc.slf',
                            eps=[1e-1])
    ...
    def _post(self):
        ...
        for idx, record in enumerate(records):
            ...
            vnv_plot1d_polylines(\
                ...
                fig_name='img/t2d_ritter_hllc_depth_firstobs{}'.format(record),
            ...
            vnv_plot2d(\
                ...
                record=record,
                fig_size=(10, 3),
                fig_name="img/t2d_ritter_hllc_depth2d_firstobs{}".format(record),
            ...
            vnv_plot1d_polylines(\
                ...
                fig_name='img/t2d_ritter_hllc_vel_firstobs{}'.format(record),
                fig_title=time_label)
            ...
            vnv_plot2d(\
                ...
                record=record,
                fig_size=(10, 3),
                fig_name="img/t2d_ritter_hllc_vel2d_firstobs{}".format(record),
                fig_title=time_label,
