...
class VnvStudy(AbstractVnvStudy):
    ...
    def _pre(self):
        ...
        #======================================================================
        # waf run
        self.add_study('waf_seq', 'telemac2d', 't2d_thacker2-waf.cas')

        #======================================================================
        # kin1 run
        self.add_study('kin1_seq', 'telemac2d', 't2d_thacker2-kin1.cas')
        # kin1 run in parallel
        cas = TelemacCas('t2d_thacker2-kin1.cas', get_dico('telemac2d'))
        cas.set('PARALLEL PROCESSORS', 4)
        self.add_study('kin1_par', 'telemac2d', 't2d_thackerv-kin1_par.cas', cas=cas)
        del cas

        #======================================================================
        # hllc run
        self.add_study('hllc_seq', 'telemac2d', 't2d_thacker2-hllc.cas')
        # hllc run in parallel
        cas = TelemacCas('t2d_thacker2-hllc.cas', get_dico('telemac2d'))
        cas.set('PARALLEL PROCESSORS', 4)
        self.add_study('hllc_par', 'telemac2d', 't2d_thacker2-hllc_par.cas', cas=cas)
        del cas
    ...
    def _check_results(self):
        ...
        self.check_epsilons('nerd_seq:T2DRES', 'f2d_thacker2.slf',
                            eps=[1e-4, 1e-4, 1e-4, 1e-4, 1.E-15,\
                                 1.E-15, 1.E-15, 1.E-15, 1.E-15])

        # sequential parallel comparison
        self.check_epsilons('char_seq:T2DRES', 'char_par:T2DRES', eps=[1.])
        self.check_epsilons('nerd_seq:T2DRES', 'nerd_par:T2DRES', eps=[1.])
        self.check_epsilons('eria_seq:T2DRES', 'eria_par:T2DRES', eps=[1.])
        self.check_epsilons('kin1_seq:T2DRES', 'kin1_par:T2DRES', eps=[1.])
        self.check_epsilons('hllc_seq:T2DRES', 'hllc_par:T2DRES', eps=[1.])
    ...
    def _post(self):
        ...
        for idx, record in enumerate(records):
            ...
            vnv_plot2d(\
                ...
                record=record,
                fig_size=(6, 5),
                fig_name="img/t2d_thacker2_nerd_seq_depth_firstobs{}".format(record),
                var_factor=1./H0,
                cbar_label='H/H0',
                xlim=xlim, ylim=ylim,
                vmin=0.01, vmax=1.25, nv=11,
                x_factor=1./A, y_factor=1./A,
                x_label='x/a', y_label='y/a',
            ...
            vnv_plot2d(\
                ...
                record=record,
                fig_size=(6, 5),
                fig_name="img/t2d_thacker2_nerd_seq_depth_dry_firstobs{}".format(record),
                var_factor=1./H0,
                cbar_label='H/H0',
                xlim=xlim, ylim=ylim,
                vmin=0.01, vmax=1.25, nv=11,
            ...
            vnv_plot2d(\
                ...
                record=record,
                fig_size=(6, 5),
                fig_name="img/t2d_thacker2_nerd_seq_vel_firstobs{}".format(record),
                var_factor=1./U0,
                cbar_label='|U|/U0',
                xlim=xlim, ylim=ylim,
                x_factor=1./A, y_factor=1./A,
