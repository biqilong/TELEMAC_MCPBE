...
%
\section{Purpose}
Thacker test cases illustrate that \telemac{2d} is able to simulate wet/dry moving transitions
...
where $H_0$ is the water depth at the central point of the domain for a zero elevation, $a$ is the distance from the central
...
%\end{figure}
%
%The bathymetry shape is shown in the Figure~\ref{fig:thacker:Bathy}
%\begin{figure}[H]
%  \centering
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{Results - Rotation of a planar surface in a parabolic boil}
...
\begin{minipage}[t]{0.5\textwidth}
 \centering
 \includegraphicsmaybe{[width=0.95\textwidth]}{../img/t2d_thacker_nerd_seq_vel_firstobs0.png}
\end{minipage}%
\begin{minipage}[t]{0.5\textwidth}
 \centering
...
\begin{minipage}[t]{0.5\textwidth}
 \centering
 \includegraphicsmaybe{[width=0.95\textwidth]}{../img/t2d_thacker_hllc_seq_depth_9.png}
\end{minipage}%
\begin{minipage}[t]{0.5\textwidth}
 \centering
 \includegraphicsmaybe{[width=0.95\textwidth]}{../img/t2d_thacker_hllc_seq_velocity_9.png}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
 \centering
 \includegraphicsmaybe{[width=0.95\textwidth]}{../img/t2d_thacker_waf_seq_depth_9.png}
\end{minipage}%
\begin{minipage}[t]{0.5\textwidth}
 \centering
 \includegraphicsmaybe{[width=0.95\textwidth]}{../img/t2d_thacker_waf_seq_velocity_9.png}
\end{minipage}
  \caption{Comparison of water depth and velocity after one rotation.}
...
$L^2$ errors time series and time integrated $L^1$, $L^2$ and $L^\infty$ errors are presented in the figures \ref{fig:thacker:ErrNumH}, \ref{fig:thacker:ErrNumU} and \ref{fig:thacker:ErrNumV} for $H$, $U$ and $V$ respectively.
...
\begin{figure}[H]
\centering
\includegraphicsmaybe{[width=0.85\textwidth]}{../img/t2d_thacker_maxT.png}
\includegraphicsmaybe{[width=0.85\textwidth]}{../img/t2d_thacker_minT.png}
...
\begin{figure}[H]
\centering
  \includegraphicsmaybe{[width=0.8\textwidth]}{../img/t2d_thacker_mass_balance.png}
...
\begin{figure}[H]
\centering
  \includegraphicsmaybe{[width=0.7\textwidth]}{../img/t2d_thacker_errors_timeintegrals_H_L2_allsc.png}
...
\begin{minipage}[t]{0.50\textwidth}
 \centering
 \includegraphicsmaybe{[width=\textwidth]}{../img/t2d_thacker_HLLC_errors_tf_finemesh_H.png}
\end{minipage}%
\begin{minipage}[t]{0.50\textwidth}
 \centering
 \includegraphicsmaybe{[width=\textwidth]}{../img/t2d_thacker_WAF_errors_tf_finemesh_H.png}
\end{minipage}
...
%is illustrated on figures \ref{fig:thacker2:WDTime} and \ref{fig:thacker2:VelocityTime}).
%
%\begin{figure}[h!]
%\begin{minipage}[t]{0.5\textwidth}
% \centering
...
\begin{minipage}[t]{0.5\textwidth}
 \centering
 \includegraphicsmaybe{[width=0.95\textwidth]}{../img/t2d_thacker2_hllc_seq_depth_9.png}
\end{minipage}%
\begin{minipage}[t]{0.5\textwidth}
 \centering
 \includegraphicsmaybe{[width=0.95\textwidth]}{../img/t2d_thacker2_hllc_seq_velocity_9.png}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
 \centering
