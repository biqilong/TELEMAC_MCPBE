...
class VnvStudy(AbstractVnvStudy):
    ...
    def _check_results(self):
        ...
        """
        self.check_epsilons('char_seq:T2DRES', 'f2d_bumpsub.slf', eps=[1.])
        self.check_epsilons('char_par:T2DRES', 'f2d_bumpsub.slf', eps=[1.])
        self.check_epsilons('char_seq:T2DRES', 'char_seq:T2DRES', eps=[1.])

        self.check_epsilons('n_seq:T2DRES', 'f2d_bumpsub.slf', eps=[1.])
        self.check_epsilons('n_par:T2DRES', 'f2d_bumpsub.slf', eps=[1.])
        self.check_epsilons('n_seq:T2DRES', 'n_seq:T2DRES', eps=[1.])

        self.check_epsilons('psi_seq:T2DRES', 'f2d_bumpsub.slf', eps=[1.])
        self.check_epsilons('psi_par:T2DRES', 'f2d_bumpsub.slf', eps=[1.])
        self.check_epsilons('psi_seq:T2DRES', 'psi_seq:T2DRES', eps=[1.])

        self.check_epsilons('lips_seq:T2DRES', 'f2d_bumpsub.slf', eps=[1.])
        self.check_epsilons('lips_par:T2DRES', 'f2d_bumpsub.slf', eps=[1.])
        self.check_epsilons('lips_seq:T2DRES', 'lips_seq:T2DRES', eps=[1.])

        self.check_epsilons('nerd_seq:T2DRES', 'f2d_bumpsub.slf', eps=[1.])
        self.check_epsilons('nerd_par:T2DRES', 'f2d_bumpsub.slf', eps=[1.])
        self.check_epsilons('nerd_seq:T2DRES', 'nerd_seq:T2DRES', eps=[1.])

        self.check_epsilons('eria_seq:T2DRES', 'f2d_bumpsub.slf', eps=[1.])
        self.check_epsilons('eria_par:T2DRES', 'f2d_bumpsub.slf', eps=[1.])
        self.check_epsilons('eria_seq:T2DRES', 'eria_seq:T2DRES', eps=[1.])

        self.check_epsilons('kin1_seq:T2DRES', 'f2d_bumpsub.slf', eps=[1e-1])
        self.check_epsilons('kin1_par:T2DRES', 'f2d_bumpsub.slf', eps=[1e-1])
        self.check_epsilons('kin1_seq:T2DRES', 'kin1_seq:T2DRES', eps=[1e-1])

        self.check_epsilons('kin2_seq:T2DRES', 'f2d_bumpsub.slf', eps=[1.])
        self.check_epsilons('kin2_par:T2DRES', 'f2d_bumpsub.slf', eps=[1.])
        self.check_epsilons('kin2_seq:T2DRES', 'kin2_seq:T2DRES', eps=[1.])

        self.check_epsilons('hllc_seq:T2DRES', 'f2d_bumpsub.slf', eps=[1e-8])
        self.check_epsilons('hllc_par:T2DRES', 'f2d_bumpsub.slf', eps=[1e-4])
