#!/usr/bin/env python
"""Provides a function to plot the validation example for YEN from Telemac
csv-files

We use the python built in csv-reader. There is no CSV standard we asume that
there is a Telemac standard
...
if PY3:
    from data_manip.formats.selafin import Selafin as SELAFIN
else:
