...
\begin{figure} [!h]
\centering
\includegraphics[scale=0.55]{EvolutionR05.png}
 \caption{Comparison of simulated (coloured) and measured (black contour lines) normalized bed evolution.}\label{fig:results1}
\end{figure}

\begin{figure} [!h]
\centering
\includegraphics[scale=0.25]{sis_yen-exp_90.png}
\includegraphics[scale=0.25]{sis_yen-exp_180.png}
...
\begin{figure} [!h]
\centering
\includegraphics[width=.96\textwidth]{EvolutionR05.png}
 \caption{Comparison of simulated (coloured) and measured (black contour lines) normalized bed evolution.}\label{fig:results1}
\end{figure}

\begin{figure} [!h]
\centering
\includegraphics[width=.96\textwidth]{sis_yen-exp_90.png}
\includegraphics[width=.96\textwidth]{sis_yen-exp_180.png}
