...
def main(recompile=True):
    ...
    chdir(path.join(root, 'examples', 'waqtel', 'heat_exchange'))

    study = Telemac3d('t3d_heat_exchange_rain_wind.cas', user_fortran='user_fortran',
                      comm=comm, recompile=recompile,waqfile='waq_steer.cas')
