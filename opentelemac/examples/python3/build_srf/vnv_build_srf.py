...
class VnvStudy(AbstractVnvStudy):
    ...
    def _pre(self):
        ...
        # Generation of a boundary serfaing file to set data on the boundary
        ...
        # Generation of a boundary serfaing file to set data from tomawac on the boundary
        ...
        # Generation of an atmonspheric file
