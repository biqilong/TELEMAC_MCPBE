...
class VnvStudy(AbstractVnvStudy):
    ...
    def _check_results(self):
        ...
        self.check_epsilons('vnv_1:WACRES',
                            ...
                            eps=[5e-7, 2e-5, 8e-6, 1e-10, 1e-10, 5e-8, 1e-10, 5e-8, 1e-10, 1e-6, 1e-6])

        # Comparison with the last time frame of the reference file.
        self.check_epsilons('vnv_2:WACRES',
                            'fom_fetch_lim_id.slf',
                            eps=[5e-7, 2e-5, 8e-6, 1e-10, 1e-10, 5e-8, 1e-10, 5e-8, 1e-10, 5e-7, 1e-6])

        # Comparison between sequential and parallel run.
        self.check_epsilons('vnv_1:WACRES',
                            'vnv_2:WACRES',
                            eps=[0.03, 0.2, 0.3, 1e-10, 1e-10, 0.005, 0.009, 0.002, 1e-10, 0.07, 0.05])

        # Comparison with the last time frame of the reference file.
        self.check_epsilons('vnv_3:WACRES',
                            'fom_fetch_lim_fd.slf',
                            eps=[5e-7, 1e-10, 2e-6, 1e-10, 1e-10, 1e-10, 2e-8, 1e-10, 2e-8, 1e-10, 5e-7, 5e-7])

        # Comparison with the last time frame of the reference file.
        self.check_epsilons('vnv_4:WACRES',
                            'fom_fetch_lim_fd.slf',
                            eps=[0.006, 0.09, 0.2, 1e-10, 1e-10, 1e-10, 0.002, 0.02, 0.0003, 1e-10, 0.02, 5e-7])

        # Comparison between sequential and parallel run.
        self.check_epsilons('vnv_3:WACRES',
                            'vnv_4:WACRES',
                            eps=[0.006, 0.09, 0.2, 1e-10, 1e-10, 1e-10, 0.002, 0.02, 0.0003, 1e-10, 0.02, 0.008])

        # Comparison with the last time frame of the reference file.
        self.check_epsilons('vnv_5:WACRES',
                            'fom_fetch_lim_test4.slf',
                            eps=[0.05, 0.31, 0.7, 1e-10, 1e-10, 0.006, 0.012, 0.002, 1e-10, 0.053, 0.07])

        # Comparison between sequential and parallel run.
        self.check_epsilons('vnv_5:WACRES',
                            'vnv_5p:WACRES',
                            eps=[0.04, 0.3, 0.3, 1e-10, 1e-10, 0.004, 0.02, 0.002, 1e-10, 0.03, 0.06])
        ...
        self.check_epsilons('vnv_6:WACRES',
                            'vnv_6p:WACRES',
                            eps=[0.006, 0.09, 0.2, 1e-10, 1e-10, 0.002, 0.02, 0.0003, 1e-10, 0.02, 0.008])
    ...
    def _post(self):
        ...
        # Closing files
        del res_vnv_5_wacres
        del res_vnv_7_wacres
        del res_vnv_3_wacres
        del res_vnv_6_wacres
        del res_vnv_3_wacgeo
